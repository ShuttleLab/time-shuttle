          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <nav>
              <ul className="flex items-center gap-2 sm:gap-4">
                ...
                <li>
                  <a href="mailto:support@shuttlelab.org" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                    {t("common.contact")}
                  </a>
                </li>
              </ul>
            ...
            <Button type="button" variant="outline" size="sm" className="text-xs h-8" onClick={toggleLocale}>
              {locale === "zh" ? "中/EN" : "EN/中"}
            </Button>
          </div>
        </div>
